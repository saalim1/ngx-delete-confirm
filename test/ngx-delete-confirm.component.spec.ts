...
xdescribe('click to edit component', () => {
    ...
    it('should show numeric field', () => {
        let fixture: ComponentFixture<NgxDeleteConfirmComponent> = TestBed.createComponent(NgxDeleteConfirmComponent);
        let component: NgxDeleteConfirmComponent = fixture.componentInstance;
